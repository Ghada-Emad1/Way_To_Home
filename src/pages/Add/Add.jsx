...
const hundelsubmitwork = (e)=>{
  ...
  if (namejob && workaddrese && workemail && Workhour && skills && Salary) {
      ...
      dispatch(work({ id:addwork.length +1 , namejob:namejob , workaddrese:workaddrese ,  workemail:workemail , Workhour:Workhour , skills :skills , Salary :Salary } ));
        ...
        {addWork ? (
          <Modal>
            <div className="bg-white w-[320px] sm:w-[550px] text-center p-5 rounded-lg  flex flex-col items-center justify-center relative  ">
                    ...
                    <div className="  mt-4">
                        <form onSubmit={hundelsubmitwork}
                        className='  gap-3'>
                            <div className='flex flex-col justify-start items-start    '>
                                    ...
                                    {errorwork.namejob && <span className="text-red-500">{errorwork.namejob}</span>}
                                ...
                                />
                                {errorwork.workaddrese && <span className="text-red-500">{errorwork.workaddrese}</span>}
                                ...
                                className={stylee}
                                />
                                {errorwork.workemail && <span className="text-red-500">{errorwork.workemail}</span>}

                                <label className="font-bold text-basic mb-2"> work hours  </label>
                                <input type='text'
                                    onChange={(e)=> {
                                ...
                                className={stylee}
                                />
                                {errorwork.Workhour && <span className="text-red-500">{errorwork.Workhour}</span>}
                                ...
                                className={stylee}
                                />
                                {errorwork.Salary && <span className="text-red-500">{errorwork.Salary}</span>}
                                ...
                                className={stylee}
                                />
                                {errorwork.skills && <span className="text-red-500">{errorwork.skills}</span>}
                                <div>
