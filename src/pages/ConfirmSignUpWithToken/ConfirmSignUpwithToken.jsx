...
const ConfirmSignUpwithToken = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post(`https://homecompass.runasp.net/Auth/confirmEmail?email=${email}&token=${token}`).then((res)=>{
            console.log(res)
            navigate("/login")
        }).catch((err)=>{
            console.log(err)
...
export default ConfirmSignUpwithToken;
